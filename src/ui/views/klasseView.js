...
window.Unterrichtsassistent.ui.views.klasse = {
  ...
  render: function (service) {
    ...
    return [
      ...
      schoolClass && isManageMode ? [
        '<div class="import-modal" id="classStudentPdfExportModal" hidden>',
        '<div class="import-modal__backdrop" onclick="return window.UnterrichtsassistentApp.closeClassStudentPdfExportModal()"></div>',
        '<div class="import-modal__dialog import-modal__dialog--compact" role="dialog" aria-modal="true" aria-labelledby="classStudentPdfExportTitle">',
        '<div class="import-modal__header">',
        '<h3 id="classStudentPdfExportTitle">Schueler als PDF exportieren</h3>',
        '<button class="import-modal__close" type="button" aria-label="Pop-up schliessen" onclick="return window.UnterrichtsassistentApp.closeClassStudentPdfExportModal()">x</button>',
        "</div>",
        '<form class="import-modal__form" autocomplete="off" method="post" action="about:blank" data-local-only-form onsubmit="return window.UnterrichtsassistentApp.submitClassStudentPdfExport(event)">',
        '<label class="import-modal__field">',
        '<span>Sortierung</span>',
        '<select id="classStudentPdfSortBy" class="student-table__input student-table__select">',
        '<option value="lastName" selected>Nachname</option>',
        '<option value="firstName">Vorname</option>',
        '</select>',
        '</label>',
        '<label class="import-modal__field">',
        '<span>Freie Spalten rechts</span>',
        '<input id="classStudentPdfFreeColumns" class="student-table__input" type="number" min="0" max="12" step="1" value="5" inputmode="numeric">',
        '</label>',
        '<label class="import-modal__field">',
        '<span>Papierformat</span>',
        '<select id="classStudentPdfPageSize" class="student-table__input student-table__select">',
        ...
        '<select id="classStudentPdfOrientation" class="student-table__input student-table__select">',
        '<option value="landscape" selected>Querformat</option>',
        '<option value="portrait">Hochformat</option>',
        '</select>',
        '</label>',
        '<label class="import-modal__field">',
        '<span>Zeilenhoehe in mm</span>',
        '<input id="classStudentPdfRowHeight" class="student-table__input" type="number" min="6" max="30" step="1" value="12" inputmode="numeric">',
        '</label>',
        '<div class="import-modal__actions">',
        '<button class="import-modal__icon-button import-modal__icon-button--cancel" type="button" aria-label="Export abbrechen" onclick="return window.UnterrichtsassistentApp.closeClassStudentPdfExportModal()">&#10005;</button>',
        '<button class="import-modal__icon-button import-modal__icon-button--confirm" type="submit" aria-label="PDF erzeugen">&#10003;</button>',
        '</div>',
        '</form>',
        '</div>',
        '</div>'
